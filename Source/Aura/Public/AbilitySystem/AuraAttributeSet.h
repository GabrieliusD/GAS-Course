...
struct FEffectProperties
{
	...
	UPROPERTY()
	AController* SourceControllerActor = nullptr;

	UPROPERTY()
	ACharacter* SourceCharacterActor = nullptr;
	...
	UPROPERTY()
	AController* TargetControllerActor = nullptr;

	UPROPERTY()
	ACharacter* TargetCharacterActor = nullptr;
};
